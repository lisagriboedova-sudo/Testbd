...
CREATE TABLE `NL_PROP_RESALE`  (
  ...
  `ID_NL_HOUSES` int(11) NULL DEFAULT NULL,
  `ID_NL_MATERIAL` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `NL_PROP_RESALE` VALUES (3, NULL, NULL, NULL,'1', 555.00, '[\"/img/prop_resale/PHOTO_URLS_3_191201_024304.jpg\"]', 1000000, 'Россия, Краснодарский край, Анапа, Советская улица ', '%7B%22ops%22%3A%5B%7B%22insert%22%3A%22%D0%A5%D0%BE%D1%80%D0%BE%D1%88%D0%B0%D1%8F%20%D0%BA%D0%B2%D0%B0%D1%80%D1%82%D0%B8%D1%80%D0%B0%5Cn%22%7D%5D%7D', 1, '+79282601474', NULL, '2019-12-01 14:44:02', '2019-12-01 14:44:02');
...
-- ----------------------------
-- Records of NL_HOUSES
-- ----------------------------
INSERT INTO `NL_HOUSES` VALUES (1, 'Панелька');
INSERT INTO `NL_HOUSES` VALUES (2, 'Высотка');
...
-- ----------------------------
-- Records of NL_MATERIAL
-- ----------------------------
INSERT INTO `NL_MATERIAL` VALUES (1, 'Кирпич');
INSERT INTO `NL_MATERIAL` VALUES (2, 'Дерево');
