<div class="dicts g-tabs-full">
    <ul>
        ...
        <li><a href="/admin/php/jqgrid.table.php?cache=20&tblName=NL_HOUSES">Дома</a></li>
        <li><a href="/admin/php/jqgrid.table.php?cache=20&tblName=NL_MATERIAL">Материалы</a></li>
    </ul>
</div>
